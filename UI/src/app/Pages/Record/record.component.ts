...
export class RecordComponent implements OnInit {
  ...
  getBirdAudio(id: string) {
    this._birdService.getPredictionAudio(id).subscribe(result => {
      this.tempAudioURL = URL.createObjectURL(result);
      console.log(this.tempAudioURL)
    })
  }
